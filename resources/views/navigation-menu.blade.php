        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('images/logos/sociality-logo.png') }}" alt="logo" class="block h-9 w-auto" />
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="relative flex">
                    <input
                        ...
                        class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full my-3"
                        x-data="{ search: '' }"
                        x-model="search"
                        x-on:keydown.window.prevent.slash="document.getElementById('searchInput').focus()"
                        id="searchInput"
                        x-on:input.debounce.300ms="Livewire.emit('searchUpdated', search)"
                    >
                @livewire('search')
                </div>
                <!-- Teams Dropdown -->
